...
export class Timer {
    // Passed milliseconds since the timer started.
    @observable milliseconds;
    // Saved milliseconds for the combined time that has passed in previous runnings.
